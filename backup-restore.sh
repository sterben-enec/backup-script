...
L[cfg_gd_switch_tg]="Upload method remains unchanged."
...
L[cfg_s3_switch_tg]="Upload method remains unchanged."
...
L[cfg_gd_switch_tg]="Способ отправки остаётся без изменений."
...
L[cfg_s3_switch_tg]="Способ отправки остаётся без изменений."
...
# Способ отправки архивов: s3 | google_drive (профиль проекта)
CFG_UPLOAD_METHOD=""
...
_send_backup() {
    ...
    methods_csv="$(_normalize_upload_methods "${CFG_UPLOAD_METHOD:-}")"
...
_apply_local_retention() {
    ...
    # Единая политика хранения для внешних хранилищ архивов.
